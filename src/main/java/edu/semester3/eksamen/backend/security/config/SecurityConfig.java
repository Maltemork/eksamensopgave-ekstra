package edu.semester3.eksamen.backend.security.config;

import com.nimbusds.jose.jwk.source.ImmutableSecret;
import edu.semester3.eksamen.backend.security.error.CustomOAuth2AccessDeniedHandler;
import edu.semester3.eksamen.backend.security.error.CustomOAuth2AuthenticationEntryPoint;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/burritos/all")).permitAll()
